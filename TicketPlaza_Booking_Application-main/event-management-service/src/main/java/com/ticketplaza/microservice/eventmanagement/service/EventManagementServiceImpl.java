...
public class EventManagementServiceImpl implements EventManagementService {
	...
	private Event convertToEntity(EventDto eventDto) {
		...
		event.setTicketType(eventDto.getTicketType());
		return event;
	}
	...
	private EventDto convertToDto(Event event) {
		...
		eventDto.setTicketType(event.getTicketType());
		return eventDto;
	}
	...
	public EventDto updateEventDetails(long id, EventDto updateEventDto) {
		...
		if(updateEventDto.getTicketType()!=null)
			existingEvent.setTicketType(updateEventDto.getTicketType());
